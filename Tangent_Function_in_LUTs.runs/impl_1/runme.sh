...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Tangent_Function_in_LUTs/Tangent_Function_in_LUTs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tengant.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tengant.tcl -notrace
