...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Tangent_Function_in_LUTs/Tangent_Function_in_LUTs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tengant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tengant.tcl
